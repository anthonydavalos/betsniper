...
const DEFAULT_DIAGNOSTICS_DATA = {
  arbitrageDiagnostics: {
    history: [],
...
const getSplitDbPaths = () => ({
  legacyDbPath,
  coreDbPath,
  diagnosticsDbPath
});

const readMergedDbSync = () => {
...
const writeMergedDbSync = (mergedDb = {}, { writeLegacyMirror = false } = {}) => {
